package com.examly.gowuthamclassexercise2.model;

import jakarta.persistence.Entity;
import jakarta.persistence.Id;

@Entity
public class GowuthamCourse {
     ...
     public GowuthamCourse() {

     }

     public GowuthamCourse(int courseId, String courseName, int creditHours, String instructor, String preRequistes,
