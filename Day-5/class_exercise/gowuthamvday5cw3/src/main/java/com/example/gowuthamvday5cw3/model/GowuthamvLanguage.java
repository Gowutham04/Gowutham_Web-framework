package com.example.gowuthamvday5cw3.model;

import jakarta.persistence.Entity;
import jakarta.persistence.Id;

@Entity
public class GowuthamvLanguage {
    @Id
    private int languageId;
    private String languageName;
    private String languageComplexity;
    public GowuthamvLanguage() {
    }
    public GowuthamvLanguage(int languageId, String languageName, String languageComplexity) {
