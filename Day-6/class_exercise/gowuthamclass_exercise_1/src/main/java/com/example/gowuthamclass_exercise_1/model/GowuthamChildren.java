package com.example.gowuthamclass_exercise_1.model;

import jakarta.persistence.Entity;
import jakarta.persistence.Id;

@Entity
public class GowuthamChildren {
     @Id
     private int babyId;
     ...
     public GowuthamChildren() {

     }

     public GowuthamChildren(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
               String address) {
          this.babyId = babyId;
