...
public class GowuthamVillage {
    ...
    public GowuthamVillage(){}
    public GowuthamVillage(int villageId, String villageName, int numOfMen, int numOfWomen, int villagePopulation,
            int numOfSchools) {
